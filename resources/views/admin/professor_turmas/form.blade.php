...
@section('main')
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-user-o"></i> Professores de Turmas</h1>
          <p>{{isset($show)?'Ver':'Formulário'}}</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="{{url('admin/professor_turmas')}}">Professores de Turmas</a></li>
        ...
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">
              ...
              {{isset($item->id)?isset($show)?'Ver':'Editar':'Cadastrar'}} Professor de Turma</h3>
            <div class="tile-body">
              {!! Form::open(['url' => 'admin/professor_turmas']) !!}
            ...
            <div class="tile-footer">
              ...
              @else
              <a href="{{url('admin/professor_turmas/'.$item->id.'/edit')}}" class="btn btn-secondary"><i class="fa fa-fw fa-lg fa-check-circle"></i>Editar</a>
              @endif
            </div>
            {{ Form::close() }}
          </div>
