...
@section('main')
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Graus de Dificuldades das Aulas &nbsp;&nbsp;<a href="{{url('admin/grauDificuldades/create')}}" class="text-primary" alt="Cadastrar"><span class="fa fa-plus"></span></a></h1>
          <p>Tabela com todos os Graus de Dificuldades das Aulas</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Graus de Dificuldades das Aulas</li>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$item->nome}}</td>
                      <td>
                      <a href="{{url('admin/grauDificuldades/'.$item->id.'/edit')}}" class="text-primary"><span class="fa fa-edit"></span></a>
                      @if(!$item->aulas()->exists())
  ...
  $( document ).ready(function() {
    ...
    $("a#delete_item").click(function(e){
        ...
        if (confirm("Você tem certeza que quer apagar?")) {
          ...
          $.ajax({
            url: "grauDificuldades/"+id, //or you can use url: "company/"+id,
            type: 'post',
            dataType: "json",
            data: {
              _token: token,
