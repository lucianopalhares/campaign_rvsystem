...
@section('main')
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-vcard-o"></i> Graus de Dificuldades das Aulas</h1>
          <p>Formulário</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="{{url('admin/grauDificuldades')}}">Graus de Dificuldades das Aulas</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">{{isset($item->id)?'Editar':'Cadastrar'}} Grau de Dificuldade</h3>
            <div class="tile-body">
              {!! Form::open(['url' => 'admin/grauDificuldades']) !!}
