...
@section('main')
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-user-o"></i> Alunos&nbsp;&nbsp;<a href="{{url('admin/alunos/create')}}" class="text-primary" alt="Cadastrar"><span class="fa fa-plus"></span></a></h1>
          <p>Tabela com todos os Alunos</p>
        </div>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a href="{{url('admin/alunos/'.$item->id.'/edit')}}" class="text-primary"><span class="fa fa-edit"></span></a>
                      <!--if(!item->users()->exists())-->
                      <a href="{{url('admin/alunos/'.$item->id)}}" class="text-secondary"><span class="fa fa-eye"></span></a>
  ...
  jQuery(document).ready(function(){
    ...
    $("a#delete_item").click(function(e){
        ...
        if (confirm("Você tem certeza que quer apagar?")) {
          ...
          $.ajax({
            url: "alunos/"+id, //or you can use url: "company/"+id,
            type: 'post',
            dataType: "json",
            data: {
              _token: token,
