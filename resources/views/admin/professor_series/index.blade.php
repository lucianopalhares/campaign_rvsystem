...
@section('main')
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-user-o"></i> Professores de Series&nbsp;&nbsp;<a href="{{url('admin/professor_series/create')}}" class="text-primary" alt="Cadastrar"><span class="fa fa-plus"></span></a></h1>
          <p>Tabela com todos os Professores de Series</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Professores de Series</li>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a href="{{url('admin/professor_series/'.$item->id.'/edit')}}" class="text-primary"><span class="fa fa-edit"></span></a>
  ...
  jQuery(document).ready(function(){
    ...
    $("a#delete_item").click(function(e){
        ...
        if (confirm("Você tem certeza que quer apagar?")) {
          ...
          $.ajax({
            url: "professor_series/"+id, //or you can use url: "company/"+id,
            type: 'post',
            dataType: "json",
            data: {
              _token: token,
