...
@section('main')
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-podcast"></i> Series &nbsp;&nbsp;<a href="{{url('admin/series/create')}}" class="text-primary" alt="Cadastrar"><span class="fa fa-plus"></span></a></h1>
          <p>Tabela com todos os Series</p>
        </div>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$item->nome}}</td>
                      <td>{{$item->ordem}}</td>
                      <td><img src="/images/series/{{$item->imagem}}" width="50" height="40" alt=""></td>
                      <td>
                      <a href="{{url('admin/series/'.$item->id.'/edit')}}" class="text-primary"><span class="fa fa-edit"></span></a>
  ...
  jQuery(document).ready(function(){
    ...
    $("a#delete_item").click(function(e){
        ...
        if (confirm("Você tem certeza que quer apagar?")) {
          ...
          $.ajax({
            url: "series/"+id, //or you can use url: "company/"+id,
            type: 'post',
            dataType: "json",
            data: {
              _token: token,
