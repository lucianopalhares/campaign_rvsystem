...
@section('main')
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-wpexplorer"></i> Disciplinas &nbsp;&nbsp;<a href="{{url('admin/disciplinas/create')}}" class="text-primary" alt="Cadastrar"><span class="fa fa-plus"></span></a></h1>
          <p>Tabela com todas as Disciplinas</p>
        </div>
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$item->nome}}</td>
                      <td><img src="/images/disciplinas/{{$item->imagem}}" width="50" height="40" alt=""></td>
                      <td>
                        
                      <a href="{{url('admin/disciplinas/'.$item->id.'/edit')}}" class="text-primary"><span class="fa fa-edit"></span></a>
  ...
  jQuery(document).ready(function(){
    ...
    $("a#delete_item").click(function(e){
        ...
        if (confirm("Você tem certeza que quer apagar?")) {
          ...
          $.ajax({
            url: "disciplinas/"+id, //or you can use url: "company/"+id,
            type: 'post',
            dataType: "json",
            data: {
              _token: token,
