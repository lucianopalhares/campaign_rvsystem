...
@section('main')
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-ravelry"></i> DRC/LRV's&nbsp;&nbsp;<a href="{{url('admin/drc_lrvs/create')}}" class="text-primary" alt="Cadastrar"><span class="fa fa-plus"></span></a></h1>
          <p>Tabela com todos os DRC/LRV's</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">DRC/LRV's</li>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  <thead>
                    <tr>
                      ...
                      <th>Habilidade Descrição</th>
                      <th>Objeto Conhecimento Código</th>
                      <th>Objeto Conhecimento Descrição</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$item->campo_atuacao}}</td>
                      <td>{{$item->unidade_tematica}}</td>
                      <td>{{$item->habilidade_codigo}}</td>
                      <td>{{$item->habilidade_descricao}}</td>
                      <td>{{$item->objeto_conhecimento_codigo}}</td>
                      <td>{{$item->objeto_conhecimento_descricao}}</td>
                      <td>
                        
                      <a href="{{url('admin/drc_lrvs/'.$item->id.'/edit')}}" class="text-primary"><span class="fa fa-edit"></span></a>
