...
@section('main')
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-user-o"></i> Faltas de Alunos&nbsp;&nbsp;<a href="{{url('admin/aluno_faltas/create')}}" class="text-primary" alt="Cadastrar"><span class="fa fa-plus"></span></a></h1>
          <p>Tabela com todas as Faltas de Alunos</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Faltas de Alunos</li>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a href="{{url('admin/aluno_faltas/'.$item->id.'/edit')}}" class="text-primary"><span class="fa fa-edit"></span></a>
                      <!--if(!item->users()->exists())-->
                      <a href="{{url('admin/aluno_faltas/'.$item->id)}}" class="text-secondary"><span class="fa fa-eye"></span></a>
  ...
  jQuery(document).ready(function(){
    ...
    $("a#delete_item").click(function(e){
        ...
        if (confirm("Você tem certeza que quer apagar?")) {
          ...
          $.ajax({
            url: "aluno_faltas/"+id, //or you can use url: "company/"+id,
            type: 'post',
            dataType: "json",
            data: {
              _token: token,
