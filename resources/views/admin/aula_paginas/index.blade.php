...
@section('main')
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Páginas das Aulas &nbsp;&nbsp;<a href="{{url('admin/paginas_aula/create')}}" class="text-primary" alt="Cadastrar"><span class="fa fa-plus"></span></a></h1>
          <p>Tabela com todas Páginas das Aulas</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Páginas das Aulas</li>
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$item->id}}</td>
                      <td>{{$item->aula->nome}} <small>(id:{{$item->aula_id}})</small></td>
                      <td width="10%">
                      <a href="{{url('admin/paginas_aula/'.$item->id.'/edit')}}" class="text-primary"><span class="fa fa-edit"></span></a>
  ...
  $( document ).ready(function() {
    ...
    $("a#delete_item").click(function(e){
        ...
        if (confirm("Você tem certeza que quer apagar?")) {
          ...
          $.ajax({
            url: "paginas_aula/"+id, //or you can use url: "company/"+id,
            type: 'post',
            dataType: "json",
            data: {
              _token: token,
