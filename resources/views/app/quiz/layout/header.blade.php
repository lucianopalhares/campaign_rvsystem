    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview {{ (request()->is('app/campanha/'.$quizCampaign->slug.'/bairros/*')) ? 'is-expanded' : '' }} {{ (request()->is('app/campanha/'.$quizCampaign->slug.'/bairros')) ? 'is-expanded' : '' }}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-map"></i><span class="app-menu__label">Bairros</span><span class="badge badge-primary">{{$quizCampaign->districts->count()}}</span>&nbsp;&nbsp;&nbsp;<i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item {{ (request()->is('app/campanha/'.$quizCampaign->slug.'/bairros')) ? 'active' : '' }}" href="{{url('app/campanha/'.$quizCampaign->slug.'/bairros')}}"><i class="icon fa fa-circle-o"></i> Todos Bairros</a></li>
            <li><a class="treeview-item {{ (request()->is('app/campanha/'.$quizCampaign->slug.'/bairros/create')) ? 'active' : '' }}" href="{{url('app/campanha/'.$quizCampaign->slug.'/bairros/create')}}"><i class="icon fa fa-circle-o"></i> Criar Bairro</a></li>
          </ul>
        </li>

        <li><a class="app-menu__item {{ (request()->is('app/campanha/'.$quizCampaign->slug.'/grafico')) ? 'active' : '' }}" href="{{url('app/campanha/'.$quizCampaign->slug.'/grafico')}}"><i class="app-menu__icon fa fa-bar-chart"></i><span class="app-menu__label">Ver Gráfico</span></a></li>

        <li><a class="app-menu__item {{ (request()->is('app/campanha/'.$quizCampaign->slug.'/responder-perguntas')) ? 'active' : '' }}" href="{{url('app/campanha/'.$quizCampaign->slug.'/responder-perguntas')}}"><i class="app-menu__icon fa fa-plus"></i><span class="app-menu__label">Responder Perguntas</span></a></li>
